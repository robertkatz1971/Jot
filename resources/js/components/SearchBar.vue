<template>
    <div>
      <div v-if="focus" @click="focus = false" class="bg-black opacity-25 absolute right-0 left-0 top-0 
        bottom-0 z-10">
      </div>
      <div class="relative z-10">
        ...
        <input class="w-64 mr-6 bg-gray-200 border border-gray-400 
            focus:outline-non focus: border-blue-500 focus:shadow focus:bg-gray-100 pl-8 
