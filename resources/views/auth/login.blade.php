...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <h2 class="text-blue-300 pt-1">Enter your credentials below</h2>    
        <div class="w-4/4">
            <form class="pt-8" method="POST" action="{{ route('login') }}">
                ...
                <div class="relative pt-3" >
                    ...
                    <input id="password" type="password" class="fpt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password" autocomplete="current-password">
