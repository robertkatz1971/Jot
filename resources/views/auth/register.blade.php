...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <h2 class="text-blue-300 pt-1">Enter your information below</h2>
        <div class="w-4/4">
            <form class="pt-8" method="POST" action="{{ route('register') }}">
                @csrf
                <div class="relative">
                    <label for="name" class="uppercase text-blue-500 text-xs font-bold absolute pl-2 pt-1">Full Name</label>
                ...
                <div class="relative pt-3">
                    <label for="email" class="uppercase text-blue-500 text-xs font-bold absolute pl-2 pt-1">E-mail</label>
                    ...
                    <div class="">
                        <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email" 
                            value="{{ old('email') }}" autocomplete="email" autofocus placeholder="your@email.com">
                ...
                <div class="relative pt-3">
                    <label for="password" class="uppercase text-blue-500 text-xs font-bold absolute pl-2 pt-1">Password</label>

                    <div class="">
                        <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password" 
                ...
                <div class="relative pt-3">
                    <label for="password-confirm" class="uppercase text-blue-500 text-xs font-bold absolute pl-2 pt-1">Re-enter Password</label>
                    ...
                    <div class="">
                        <input id="password-confirm" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password_confirmation" 
                            autocomplete="new-password" autofocus placeholder="Confirm">   
                    </div>
                </div>
                <div class="pt-8">
                    <button type="submit" class="w-full py-2 px-3 text-left bg-blue-200 uppercase rounded text-blue-800 font-bold">
                        Register
                    </button>
                </div>
                <div class="flex justify-between text-white pt-8 text-sm font-bold">
